                    ...
                    <div class="card card-details">
                        ...
                        <div class="member mt-3">
                            ...
                            <form action="{{ route('checkout-create', $item->id) }}" method="POST" class="form-inline">
                                ...
                                <select name="is_visa" class="custom-select mb-2 mr-sm-2" id="is_visa" required>
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    <input type="text" class="form-control datepicker" name="doe_passport" id="doe_passport" placeholder="DOE Passport" required>
                                </div>
